...
//
//    Types(ImmutabilityStrategy strategy, Member strategyAccessor) {
//        this.classPool = new ClassPool();
//        classPool.appendClassPath(new LoaderClassPath(Thread.currentThread().getContextClassLoader()));
//        this.strategy = Objects.requireNonNull(strategy);
//        this.strategyMember = strategyAccessor;
//    }
//
...
//            CtClass targetFactoryClass = classPool.makeClass(prefix + "Factory");
...
//            map.put("strategy", new StaticMethodInvocationExpression((Method)strategyMember, factory));
//        }
//        else if (strategyMember instanceof Field) {
//            map.put("strategy", new StaticFieldLoadExpression((Field)strategyMember, factory));
//        }
//        return map;
//    }
//
...
//            Class<?> result = coalesce(strategy.translate(clazz), clazz);
//            // Now translate grain schemas, if applicable.
//            result = coalesce(schemaToGrain(result), result);
